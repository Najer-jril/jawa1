public class Mhs {
    ...
    public String toString() {
        return "Mahasiswa : " + this.nim + ", " + this.nama + ", " + this.pelanggaran.getDeskripsi() + ", "
                + this.pelanggaran.getKategori().getJenis() + ", " + this.pelanggaran.getSanksi().getKeterangan() + ", "
                + this.pelanggaran.getSanksi().getPoin();
    }
}
